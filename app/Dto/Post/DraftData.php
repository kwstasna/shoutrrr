...
final class DraftData
{
     ...
     * @param  array<string, array{auto_split?: bool, tiktok_options?: TikTokOptionsData|null, content_override?: array{segments: list<string>, media_ids: list<string>}|null}>  $targetsByAccount
     */
