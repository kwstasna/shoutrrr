...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('post_targets', function (Blueprint $table): void {
            ...
            // so these ride on post_targets alongside the other per-target fields
            // (auto_split, content_override) rather than in a satellite table.
            // Every column is defaulted or nullable, so targets on the other seven
            // platforms are unaffected and existing rows need no backfill.
            ...
            $table->string('tiktok_post_mode')->default('direct_post')->after('auto_split');
