 ...
 *
 * Goes further than StoryPreview deliberately: a TikTok post is *motion*, so a
 * frozen poster frame would not tell the user what they are actually publishing.
 * Video autoplays muted and loops, and a photo post plays as the auto-advancing
 * carousel TikTok calls "photo mode" — both exactly as a viewer would meet them.
 *
