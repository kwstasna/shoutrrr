...
// Base UI's Menu.GroupLabel throws unless it is inside a Menu.Group/RadioGroup,
// but this app (like Radix's DropdownMenu.Label) uses standalone section
// headings. Render a plain styled div so the label works anywhere; wrap it in
// <DropdownMenuGroup> when it should semantically label a group's items.
